...
const CONTRACTS = {
  monad: { usdcc: '0x85822c2c6F2924Bb211e0eaC24C592e7b7412036', explorer: 'https://monadvision.com' },
  near: { usdcc: 'usdcc-token.gemsrock-nft.near', explorer: 'https://nearblocks.io' },
}

export default function Dashboard() {
  const account = useActiveAccount()
  const [balances, setBalances] = useState({ monadUSDCC: '—', nearUSDCC: '—', monadMON: '—' })
    ...
    <div className="section">
      ...
      <div className="card" style={{ marginBottom: '1.5rem', display: 'flex', gap: '2rem', flexWrap: 'wrap', alignItems: 'center' }}>
        {[
          ...
          { label: 'Uniswap V4 Pool', url: '#', chain: 'MONAD' },
      ...
      <div className="grid-4" style={{ marginBottom: '2rem' }}>
        {[
          ...
          <div key={i} className="card" style={{ textAlign: 'center' }}>
            <div style={{ fontSize: '1.5rem', fontFamily: 'Orbitron', fontWeight: 900, color: b.color, textShadow: `0 0 15px ${b.color}66`, marginBottom: '4px' }}>{b.val}</div>
      ...
      <div className="grid-2" style={{ marginBottom: '2rem' }}>
        <div className="card">
          ...
          {[
            ...
            { label: 'Uniswap V4 Pool Manager', addr: '0xb362A2b8...180048', url: 'https://monadvision.com/address/0xb362A2b87695a71A65092bd500fB05B558180048' },
        ...
        <div className="card">
          ...
          {[
            ...
            { label: 'Ref Finance Pool', addr: 'v2.ref-finance.near', url: 'https://app.ref.finance' },
          ].map((c, i) => (
            <div key={i} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '8px 0', borderBottom: '1px solid rgba(200,150,12,0.1)' }}>
              <span style={{ fontSize: '0.8rem', color: 'rgba(255,229,102,0.7)' }}>{c.label}</span>
            ...
            <tbody>
              {txHistory.map((tx, i) => (
                <tr key={i} style={{ borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
                  ...
                  <td style={{ padding: '10px 12px' }}><span style={{ background: 'rgba(57,255,20,0.1)', color: 'var(--green-toxic)', border: '1px solid rgba(57,255,20,0.3)', borderRadius: '4px', padding: '2px 8px', fontSize: '0.65rem', fontFamily: 'Orbitron' }}>✓ {tx.status}</span></td>
                </tr>
              ))}
            </tbody>
          </table>
